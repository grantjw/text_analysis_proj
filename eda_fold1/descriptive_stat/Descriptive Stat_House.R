...
house_2012 <- House_2012_f 
house_2014 <- House_2014_f 
house_2016 <- House_2016_f 
house_2018 <- House_2018_f 
...
#2012 
a <- house_2012 %>% group_by(party, issue65) %>%
...
#2014 
a <- house_2014  %>% group_by(party, issue65) %>%
  filter(issue65 %in% c(0,1)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- house_2016  %>% group_by(party, issue65) %>%
  filter(issue65 %in% c(0,1)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- house_2018  %>% group_by(party, issue65) %>%
  filter(issue65 %in% c(0,1)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- house_2012 %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2014 
a <- house_2014  %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- house_2016  %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- house_2018  %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- house_2012 %>% group_by(party, anger, issue65, issue20) %>%
...
#2014 
a <- house_2014  %>% group_by(party, anger, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- house_2016  %>% group_by(party, anger, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- house_2018  %>% group_by(party, anger, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- house_2012 %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2014 
a <- house_2014  %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- house_2016  %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- house_2018  %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- house_2012 %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2014 
a <- house_2014  %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- house_2016  %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- house_2018  %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- house_2012 %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2014 
a <- house_2014  %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- house_2016  %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- house_2018  %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- house_2012 %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2014 
a <- house_2014  %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- house_2016  %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- house_2018  %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
