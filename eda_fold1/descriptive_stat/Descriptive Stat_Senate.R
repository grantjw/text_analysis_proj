...
senate_2012 <- Senate_2012_f 
senate_2014 <- Senate_2014_f 
senate_2016 <- Senate_2016_f 
senate_2018 <- Senate_2018_f 
...
#2012 
a <- senate_2012 %>% group_by(party, issue65) %>%
...
#2014 
a <- senate_2014  %>% group_by(party, issue65) %>%
  filter(issue65 %in% c(0,1)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- senate_2016  %>% group_by(party, issue65) %>%
  filter(issue65 %in% c(0,1)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- senate_2018  %>% group_by(party, issue65) %>%
  filter(issue65 %in% c(0,1)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- senate_2012 %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2014 
a <- senate_2014  %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- senate_2016  %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- senate_2018  %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- senate_2012 %>% group_by(party, anger, issue65, issue20) %>%
...
#2014 
a <- senate_2014  %>% group_by(party, anger, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- senate_2016  %>% group_by(party, anger, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- senate_2018  %>% group_by(party, anger, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- senate_2012 %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2014 
a <- senate_2014  %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- senate_2016  %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- senate_2018  %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- senate_2012 %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2014 
a <- senate_2014  %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- senate_2016  %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- senate_2018  %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- senate_2012 %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2014 
a <- senate_2014  %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- senate_2016  %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- senate_2018  %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012 
a <- senate_2012 %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2014 
a <- senate_2014  %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016 
a <- senate_2016  %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2018 
a <- senate_2018  %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
