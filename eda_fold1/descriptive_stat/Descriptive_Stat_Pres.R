...
pres_2012 <- Pres_2012_f 
pres_2016 <- Pres_2016_f 
...
#2012
a <- pres_2012  %>% group_by(party, issue65) %>%
...
#2016
a <- pres_2016  %>% group_by(party, issue65) %>%
  filter(issue65 %in% c(0,1)) %>%
  filter(party == 1) %>% tally()
...
#2012
a <- pres_2012  %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2016
a <- pres_2016  %>% group_by(party, anger, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012
a <- pres_2012  %>% group_by(party, anger, issue65, issue20) %>%
...
#2016
a <- pres_2016  %>% group_by(party, anger, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(anger %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012
a <- pres_2012  %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2016 
a <- pres_2016  %>% group_by(party, fear, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012
a <- pres_2012  %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2016
a <- pres_2016  %>% group_by(party, fear, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(fear %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012
a <- pres_2012  %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
...
#2016
a <- pres_2016  %>% group_by(party, sadness, issue65) %>%
  filter(issue65 %in% c(1)) %>%
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2012
a <- pres_2012  %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
...
#2010
a <- pres_2016  %>% group_by(party, sadness, issue65, issue20) %>%
  filter(issue65 %in% c(1) & issue20 %in% c(1))  %>% 
  filter(sadness %in% c(1,2)) %>%
  filter(party == 1) %>% tally()
